...
#zoom 4, just the last frame                  
p12 = product.product('rando',style='numbertest',width=400)
p12.get_frames()

p13 = product.product('Tc_raw',fname='browser/u05_ct.h5',field='collapse_times',style='value',width=400)

p14 = product.product('Tc_global',fname='browser/u05_ct_glob.h5',field='collapse_times',style='value',width=400)

p15 = product.product('Tc_local',fname='browser/u05_ct_local.h5',field='collapse_times',style='value',width=400)
...
cl=make_page.make_page([p14,p15,p13,p12,p3,p4,p7,p8,p5,p2,p9,p11],
                       core_list=core_list,htmlname='./browser/output_d1.html')
