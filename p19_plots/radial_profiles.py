...
if 1:
    reload(loop_apps)
    tll.core_list=[8] #all_cores
    tll.frame_list=[20] #[20,30,40]

    #loop_apps.core_radial(tll,fields=['radius','density'],weight_field='cell_volume')
    loop_apps.core_proj_follow(tll,field='density',axis_list=[0])
